...
const learn = defineCollection({
  loader: glob({ pattern: '**/[^_]*.{md,mdx}', base: '../../content/learn' }),
  schema: z.object({
    title: z.string(),
    ...
    learning_path: z.string().optional(), // optional learning path ID
    step_number: z.number().optional(), // optional step number in path
  })
});
